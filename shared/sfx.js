...
function tone({type="sine", f=440, t=0.08, vol=0.2, slide=0, attack=0.005}) {
  ...
  const now=ctx.currentTime; g.gain.linearRampToValueAtTime(vol, now+attack);
...
export const SFX = {
  ...
  boom:()=>{tone({type:"sawtooth", f:120, t:0.25, vol:0.3, slide:-100}); setTimeout(()=>tone({type:"triangle", f:60, t:0.25, vol:0.25, slide:-40}),70);}
}
